...
![Badge](https://cp-logo.vercel.app/codechef/MMRZ?logo=true)
![Badge](https://cp-logo.vercel.app/yukicoder/MMRZ?logo=true)
![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/Memories-of-Sun-and-Moon/cp_templates)

競技プログラミング用に使っているライブラリです。
