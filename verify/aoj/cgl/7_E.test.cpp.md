...
data:
  ...
  attributes:
    ...
    ERROR: 1e-6
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/1/CGL_7_E
    links:
    - https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/1/CGL_7_E
  bundledCode: "#line 1 \"verify/aoj/cgl/7_E.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/1/CGL_7_E\"\
    ...
    \ c2.c, r));\n\treturn area(c1, a1) + area(c2, a2) - s;\n}\n#line 6 \"verify/aoj/cgl/7_E.test.cpp\"\
    \n\nusing namespace mmrz;\n\nvoid mmrz::solve(){\n\tcircle a, b;\n\tcin >> a;\n\
    \tcin >> b;\n\tauto [p1, p2] = get_crosspoints(a, b);\n\tif(p1.x > p2.x)swap(p1,\
    \ p2);\n\telse if(fabs(p1.x - p2.x) < EPS && p1.y > p2.y)swap(p1, p2);\n\tcout\
    \ << p1 << \" \" << p2 << '\\n';\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/1/CGL_7_E\"\
    \n#define ERROR \"1e-6\"\n\n#include \"./../../../template/template.hpp\"\n#include\
    \ \"./../../../geometry/util.hpp\"\n\nusing namespace mmrz;\n\nvoid mmrz::solve(){\n\
    \tcircle a, b;\n\tcin >> a;\n\tcin >> b;\n\tauto [p1, p2] = get_crosspoints(a,\
    \ b);\n\tif(p1.x > p2.x)swap(p1, p2);\n\telse if(fabs(p1.x - p2.x) < EPS && p1.y\
    \ > p2.y)swap(p1, p2);\n\tcout << p1 << \" \" << p2 << '\\n';\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: verify/aoj/cgl/7_E.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/cgl/7_E.test.cpp
- /verify/verify/aoj/cgl/7_E.test.cpp.html
