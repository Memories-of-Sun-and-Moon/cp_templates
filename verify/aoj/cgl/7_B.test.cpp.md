...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/cgl/7_B.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/1/CGL_7_B\"\
    ...
    \ c2.c, r));\n\treturn area(c1, a1) + area(c2, a2) - s;\n}\n#line 6 \"verify/aoj/cgl/7_B.test.cpp\"\
  ...
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/1/CGL_7_B\"\
    ...
    \ \"./../../../geometry/util.hpp\"\n\nusing namespace mmrz;\n\nvoid mmrz::solve(){\n\
    \tpoint p1, p2, p3;\n\tcin >> p1 >> p2 >> p3;\n\tcout << incircle_of_a_triangle(p1,\
    \ p2, p3) << '\\n';\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: verify/aoj/cgl/7_B.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/cgl/7_B.test.cpp
- /verify/verify/aoj/cgl/7_B.test.cpp.html
