...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/cgl/3_B.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/1/CGL_3_B\"\
    ...
    \t}\n\treturn d;\n}\n#line 5 \"verify/aoj/cgl/3_B.test.cpp\"\n\nusing namespace\
    \ mmrz;\n\nvoid mmrz::solve(){\n\tint n;\n\tcin >> n;\n\tvector<point> poly(n);\n\
  ...
  verifiedWith: []
documentation_of: verify/aoj/cgl/3_B.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/cgl/3_B.test.cpp
- /verify/verify/aoj/cgl/3_B.test.cpp.html
