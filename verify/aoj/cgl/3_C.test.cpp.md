...
data:
  ...
  bundledCode: "#line 1 \"verify/aoj/cgl/3_C.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/1/CGL_3_C\"\
    ...
    \ c2.c, r));\n\treturn area(c1, a1) + area(c2, a2) - s;\n}\n#line 5 \"verify/aoj/cgl/3_C.test.cpp\"\
    \n\nusing namespace mmrz;\n\nvoid mmrz::solve(){\n\tint n;\n\tcin >> n;\n\tpolygon\
    \ ps(n);\n\trep(i, n)cin >> ps[i];\n\tint q;\n\tcin >> q;\n\twhile(q--){\n\t\t\
    point p;\n\t\tcin >> p;\n\t\tcout << contains(ps, p) << '\\n';\n\t}\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/1/CGL_3_C\"\
  ...
  verifiedWith: []
documentation_of: verify/aoj/cgl/3_C.test.cpp
layout: document
redirect_from:
- /verify/verify/aoj/cgl/3_C.test.cpp
- /verify/verify/aoj/cgl/3_C.test.cpp.html
