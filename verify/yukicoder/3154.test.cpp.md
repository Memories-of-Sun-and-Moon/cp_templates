...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/3154
    links:
    - https://yukicoder.me/problems/no/3154
  bundledCode: "#line 1 \"verify/yukicoder/3154.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/no/3154\"\
    ...
    \t}\n\treturn d;\n}\n#line 5 \"verify/yukicoder/3154.test.cpp\"\n\nusing namespace\
    \ mmrz;\n\nvoid mmrz::solve(){\n\tint n;\n\tcin >> n;\n\tpolygon ps(n);\n\trep(i,\
    \ n){\n\t\tcin >> ps[i].x >> ps[i].y;\n\t}\n\tauto qs = convex_hull(ps, false);\n\
    \tcout << (len(qs) == n ? \"Yes\\n\" : \"No\\n\");\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/3154\"\n\n#include \"\
  ...
  verifiedWith: []
documentation_of: verify/yukicoder/3154.test.cpp
layout: document
redirect_from:
- /verify/verify/yukicoder/3154.test.cpp
- /verify/verify/yukicoder/3154.test.cpp.html
